...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '7dcef8fe3e293d4160356eb9d352b175',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: '256Sarfa <app@flatlogic.app>',
  ...
  project_uuid: 'f9b1e6d2-b137-4666-9708-5e995d08eb28',
  flHost:
...
config.pexelsQuery = 'abstract dark elegant design';
config.host =
