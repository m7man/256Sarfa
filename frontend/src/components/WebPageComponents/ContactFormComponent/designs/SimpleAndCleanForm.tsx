      ...
      <div
        className={`${corners !== 'rounded-full' ? corners : 'rounded-3xl'} ${
          design === ContactFormDesigns.SIMPLE_CLEAN_DIVERSITY
            ? 'bg-midnightBlueTheme-diversityContact '
            : 'bg-midnightBlueTheme-buttonColor'
        } p-12  mb-16`}
      >
          ...
          >
            ...
            <div className='space-y-2'>
              ...
              >
                ...
                />
                <a href='mhmanx@gmail.com'>mhmanx@gmail.com</a>
              </p>
            </div>
          </div>
          <div>
              ...
              {({ isSubmitting }) => (
                ...
                >
                  ...
                  <BaseButton
                    ...
                    className={`w-1/2 md:w-1/4 text-sm mt-4 text-midnightBlueTheme-buttonColor   ${corners}`}
