...
const ListCvs = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_CVS');
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    {dataFormatter.filesFormatter(item.document).map((link) => (
                      <button
                        key={link.publicUrl}
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/cvs/cvs-edit/?id=${item.id}`}
                  pathView={`/cvs/cvs-view/?id=${item.id}`}
