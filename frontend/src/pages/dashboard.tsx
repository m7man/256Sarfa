...
const Dashboard = () => {
  ...
  const [cvs, setCvs] = React.useState('Loading...');
  const [job_offers, setJob_offers] = React.useState('Loading...');
  const [job_postings, setJob_postings] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_CVS') && (
          ...
          {hasPermission(currentUser, 'READ_JOB_OFFERS') && (
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiBriefcase || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
          ...
          {hasPermission(currentUser, 'READ_JOB_POSTINGS') && (
            <Link href={'/job_postings/job_postings-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiClipboardTextOutline || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
