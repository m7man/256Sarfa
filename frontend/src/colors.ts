...
export const colorsBgLight = {
  ...
  light:
    ' bg-midnightBlueTheme-outsideCardColor text-primaryText text-primaryText dark:bg-dark-900 dark:text-white',
...
export const getButtonColor = (
  ...
  const colors = {
    ring: {
      ...
      whiteDark: 'ring-midnightBlueTheme-outsideCardColor  dark:ring-dark-500',
    ...
    bg: {
      white: 'bg-white text-black',
      whiteDark:
        'bg-midnightBlueTheme-outsideCardColor   text-primaryText  dark:bg-dark-900 dark:text-white',
      lightDark: 'bg-gray-100 text-black dark:bg-slate-800 dark:text-white',
      contrast: 'bg-gray-800 text-white dark:bg-white dark:text-black',
      success: 'bg-emerald-600 dark:bg-pavitra-blue text-white',
      danger:
        'bg-midnightBlueTheme-outsideCardColor text-red-500 dark:text-white    dark:bg-red-500 ',
    ...
    bgHover: {
      ...
      whiteDark:
        'hover:bg-midnightBlueTheme-outsideCardColor   hover:dark:bg-dark-800',
    ...
    borders: {
      white: 'border-white',
      whiteDark:
        'border-midnightBlueTheme-outsideCardColor   dark:border-dark-900',
